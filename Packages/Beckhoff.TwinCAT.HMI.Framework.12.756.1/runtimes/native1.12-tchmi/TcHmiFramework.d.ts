...
declare module TcHmi {
    ...
    class Server {
        ...
        /**
         * Get current username as string (could be __SystemGuest without auth) or null when unknown (while loading).
         * @preserve (Part of the public API)
         */
    ...
    module Server {
        ...
        interface userConfigOnServer {
            ...
            /** Current Username (could be __SystemGuest without auth) or null when unknown (while loading) */
            name: string | null;
            /** Current domain */
            domain: string | null;
...
declare module TcHmi {
    ...
    type SymbolTag = 's' | 'i' | 'l' | 'pp' | 'tp' | 'f' | 'ctrl' | 'ctx';
    enum SymbolType {
        Invalid = 0,
        Server = 10,
        Internal = 20,
...
declare module TcHmi.System {
    class FunctionExpression {
         ...
         */
        execute(ctx: SelectableRequired<TcHmi.Context, 'success' | 'error'>, skipCallbackWithSyncValue: true): FunctionExpression.IFunctionResultHandled | FunctionExpression.IFunctionResultValue;
        /**
         * Sync and Async success and errors are always handled via CTX object.
         */
        execute(ctx: SelectableRequired<TcHmi.Context, 'success' | 'error'>): FunctionExpression.IFunctionResultHandled;
...
declare module TcHmi.System {
    ...
    class Symbol<ST = any> {
         ...
         * @template T Type of the read value. Falls back to type of the symbol.
         */
        readEx<T = ST>(options: Symbol.IOptions | null, callback: (this: Symbol, data: TcHmi.Symbol.IReadResultObject<T> | TcHmi.Symbol.IServerReadResultObject<T>) => void): DestroyFunction | null;
        /**
         * @param value
         * @param callback
         * @template T Type of the write value. Falls back to type of the symbol.
         ...
         * @template T Type of the write value. Falls back to type of the symbol.
         */
        writeEx2<T = ST>(value: T, options?: Symbol.IOptions | null, dirtyPaths?: string[] | null, callback?: (this: Symbol, data: TcHmi.Symbol.IWriteResultObject<T> | TcHmi.Symbol.IServerWriteResultObject<T>) => void): DestroyFunction | null;
        /**
         * @param callback
         * @template T Type of the value to watch. Falls back to type of the symbol.
         */
         ...
         * @template T Type of the value to watch. Falls back to type of the symbol.
         */
        watchEx<T = ST>(options: Symbol.IOptions | null, callback: (this: Symbol, data: TcHmi.Symbol.IWatchResultObject<T> | TcHmi.Symbol.IServerWatchResultObject<T>) => void): DestroyFunction;
...
declare module TcHmi.System {
    class ServerManager {
         ...
         */
        watch<T = any>(expression: TcHmi.SymbolExpression, options: TcHmi.System.Symbol.IOptions | null, callback: (this: void, data: TcHmi.Symbol.IServerWatchResultObject<T>) => void): DestroyFunction;
        /**
...
declare module TcHmi.System {
    ...
    namespace Init {
        const enum INIT_STATE {
            ...
            REGISTRATION_CHECK = 18,
            OPEN_SERVER_CONNECTION = 19,
            TYPEDEFINITIONS = 20,
            SERVER_SYMBOL_SCHEMA_CACHE = 21,
            VALIDATION = 22,
            USERCONTROL_LOAD = 23,
            CONTENT_LOAD = 24,
            VIEW_LOAD = 25,
            CONTENT_COMPILE = 26,
            VIEW_COMPILE = 27,
            WAIT_FOR_PENDING_PRELOAD_BINDINGS = 28,
            FINAL = 1000,
            ERROR = 10000
        }
    }
